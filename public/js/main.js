document.addEventListener("DOMContentLoaded", function() {
            ...
            btn.addEventListener('click', function(e) {
                ...
                if (urunKarti) {
                    ...
                    if (varOlanUrun) {
                        ...
                        sepet.push({ isim, fiyat, renk, beden, adet: 1 });
                    }
    ...
    fetch('/api/products').then(res => res.json()).then(tumUrunler => {
        ...
        const offcanvasHTML = `
            ...
            <div class="offcanvas-sepet" id="offcanvasSepet">
                ...
                <div class="offcanvas-footer">
                    <a href="sepet.html" class="btn btn-ikincil" style="width: 100%; justify-content: center; margin-bottom: 10px;">Sepete Git</a>
                    <a href="odeme.html" class="btn btn-birincil" style="width: 100%; justify-content: center;">Ödemeye Geç</a>
                </div>
            </div>
        `;
    ...
    function renderOffcanvasSepet() {
        ...
        sepet.forEach(urun => {
            html += `
                <div class="mini-sepet-item">
                    <div style="flex:1;">
                        <h4 style="color: var(--beyaz);">${urun.isim}</h4>
                        <p>Renk: ${urun.renk} | Beden: ${urun.beden || 'Standart'}</p>
                        <p class="mini-sepet-fiyat">${urun.fiyat}₺ x ${urun.adet}</p>
                    </div>
                </div>
            `;
        });
